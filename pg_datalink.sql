...
CREATE FOREIGN TABLE produto (
  ...
  unidade_estoque VARCHAR(70) NOT NULL
) SERVER wpd
OPTIONS (table '(SELECT SETOR.DESCRICAO AS SETOR, PRODUTO.CODIGO, PRODUTO.DESCRICAO, ESTOQUE.EST_ATU AS ESTOQUE, PRODUTO.UNI_ESTOQU FROM ADMWPD.ESESTCAD ESTOQUE
